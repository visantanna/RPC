...
public class RMIClient {
	...
	public static void main(String [] args) {
		...
		try {
			String parametro = "testando";
			Registry registry = LocateRegistry.getRegistry(host);
			OperationsInterface stub = (OperationsInterface) registry.lookup("OperationsInterface");
			executeTests(stub);
	...
	private static void executeTests(OperationsInterface stub) {
...
class OperationAccounter{
	...
	protected OperationAccounter(OperationsInterface stub ) {
		this.stub = stub;
	}
	...
	private long funcaoString(int mult ) throws RemoteException {
		...
		this.stub.funcaoString(textoString);
		return start;
	}
}
